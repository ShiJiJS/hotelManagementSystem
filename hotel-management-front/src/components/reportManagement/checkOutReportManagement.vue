<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 24px; margin-bottom: 12px">
      ...
      <el-breadcrumb-item>离店客人报表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-row :gutter="20" style="margin-bottom: 12px">
      <el-col :span="2">
        <el-button type="primary" @click="checkInReportDialogVisible = true">打印报表</el-button>
      </el-col>
    </el-row>
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="id" label="入住单号"></el-table-column>
      <el-table-column prop="roomNumber" label="客房编号"></el-table-column>
      <el-table-column prop="roomType" label="客房类型"></el-table-column>
      <el-table-column prop="personName" label="入住人"></el-table-column>
      <el-table-column prop="vipID" label="会员编号"></el-table-column>
      <el-table-column prop="arriveTime" label="抵店时间"></el-table-column>
    ...
    <el-dialog title="打印入住客人报表" :visible.sync="checkOutReportDialogVisible" show-close="false" fullscreen center>
      <el-table :data="dialogTableData" border style="margin-bottom: 24px;  width: 80% text-align: -webkit-center">
        <el-table-column prop="id" label="入住单号"></el-table-column>
        <el-table-column prop="roomNumber" label="客房编号"></el-table-column>
        <el-table-column prop="roomType" label="客房类型"></el-table-column>
        <el-table-column prop="personName" label="入住人"></el-table-column>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="checkOutReportDialogVisible = false">取 消</el-button>
...
export default {
  ...
  data() {
    return {
      checkOutReportDialogVisible: false,
      form: {
        startDate: "",
        endDate: "",
      },
