<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 24px; margin-bottom: 12px;">
      ...
      <el-breadcrumb-item>预订客人报表</el-breadcrumb-item>
    </el-breadcrumb>
    <el-row :gutter="20" style="margin-bottom: 12px;">
      ...
      <el-col :span="2">
        <el-button type="primary" @click="reservationReportDialogVisible = true">
          打印报表
        </el-button>
      </el-col>
    </el-row>
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="id" label="预订单号">
      </el-table-column>
    ...
    <el-dialog title="打印入住客人报表" :visible.sync="reservationReportDialogVisible" fullscreen center>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="reservationReportDialogVisible = false">取 消</el-button>
...
export default {
  ...
  data() {
    return {
      reservationReportDialogVisible: false,
      form: {
        startDate: '',
        endDate: '',
      },
